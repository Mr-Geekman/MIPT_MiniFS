...
main(int argc, char* argv[]) 
{
    ...
    if (fs == NULL) 
    {
        fprintf(stderr, "Error opend file. Try init file system first.\n"); 
        exit(1); 
    }
    ...
    if(strcmp(argv[1], "read") == 0) 
    {
        ...
        read_item(argv[2][0], argv[3], inodes, fs);
    }
    ...
    else if(strcmp(argv[1], "create") == 0) 
    {
        ...
        create_item(argv[2][0], argv[3], inodes, super_block_ptr, free_map_ptr, fs);
    }
    ...
    else if(strcmp(argv[1], "delete") == 0) 
    {
        ...
        delete_item(argv[2][0], argv[3], inodes, super_block_ptr, free_map_ptr, fs);
    }
